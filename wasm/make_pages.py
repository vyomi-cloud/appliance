...
(function(){
  ...
  toggleBtn.onclick = function(){
    ...
    if(phase==="off" || phase==="idle"){ setIntent(true); render("connecting"); port.postMessage({type:"start", session:SESSION, config:CFG}); logsPane.classList.add("open"); logsBtn.textContent="Logs ▾"; }
