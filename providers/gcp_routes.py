...
_TARGET_OVERRIDES = {
    ...
    "api_gcp_storage_upload_object": gcp_storage_sql_vpc.api_gcp_storage_upload_object,
...
def register(app, h) -> None:
    ...
    specs = [
        ...
        ("POST", "/api/gcp/storage/v1/b/{bucket}/upload", "api_gcp_storage_upload_object", "(bucket: str, request: Request)"),
