...
_TARGET_OVERRIDES = {
    ...
    "api_iam_get_user": aws_iam.api_iam_get_user,
    ...
    "api_iam_get_group": aws_iam.api_iam_get_group,
    ...
    "api_iam_get_role": aws_iam.api_iam_get_role,
    ...
    "api_iam_get_policy": aws_iam.api_iam_get_policy,
...
def register(app, h) -> None:
    ...
    specs = [
        ...
        ("GET", "/api/iam/users/{user_id}", "api_iam_get_user", "(user_id: str)"),
        ...
        ("GET", "/api/iam/groups/{group_id}", "api_iam_get_group", "(group_id: str)"),
        ...
        ("GET", "/api/iam/roles/{role_id}", "api_iam_get_role", "(role_id: str)"),
        ...
        ("GET", "/api/iam/policies/{policy_id}", "api_iam_get_policy", "(policy_id: str)"),
